...
import fr.aimcvent.bukkit.api.command.ConfigurationBuilder;
import fr.aimcvent.bukkit.api.command.ConverterType;
import fr.aimcvent.bukkit.api.command.Executor;
import fr.aimcvent.bukkit.api.command.Input;
...
public class TeamExecutor implements Executor {
    ...
    public TeamExecutor(TemplateService templateService, BukkitService bukkitService) {
    ...
    public boolean execute(CommandSender sender, Input input) {
        ...
        final org.bukkit.entity.Player bukkitPlayer = (org.bukkit.entity.Player) sender;
        ...
        if (
            ...
            this.bukkitService.inventories()
                ...
                .lines(1)
                .reload(new TeamReloadInventory(this.bukkitService, this.templateService))
                .build()
                .open();
            return true;
        }
